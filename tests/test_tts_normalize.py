...
class TestPunctuatedLexicon:
    """Default style: punctuation-driven forms (owner QA3 — no staccato)."""
    ...
    def test_plural_acronym(self) -> None:
        assert normalize_spoken("Our APIs are fast.") == "Our A.P.I.s are fast."


class TestSpelledFallback:
    def test_ai_letter_spaced(self) -> None:
        assert normalize_spoken("I'm an AI.", style="spelled") == "I'm an A I."

    def test_api_letter_spaced(self) -> None:
        assert normalize_spoken("Use the API.", style="spelled") == (
            "Use the A P I."
        )

    def test_heuristic_letter_spaced(self) -> None:
        assert normalize_spoken("Sync your ERP.", style="spelled") == (
            "Sync your E R P."
        )


class TestHeuristic:
    def test_unknown_acronym_dotted(self) -> None:
    ...
    def test_alphanumeric_not_spelled(self) -> None:
